            ...
            !showProfile ?
              <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-[#ffff] relative">
                ...
                <div className='h-[61px] px-4'>
                  <div className='flex'>
                    <a className='flex items-center justify-start relative  -top-4 h-[90px]' href='/'>

                      <h3 className='LOGO text-[20px] text-[#1f2228] font-body font-extrabold tracking-wider'>LazyyChatt</h3>
                    </a>
                  </div>
                  <div className='absolute top-4 right-5 flex items-center gap-x-3'>
                    ...
                    <button onClick={() => dispatch(setShowProfile(true))} className='flex items-center gap-x-1 relative'>
                      ...
                      <GrUserSettings style={{ color: "#616c76", height: "20px", width: "20px" }} />
                    </button>
                  </div>
                </div>
