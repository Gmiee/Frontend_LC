...
import start_Chat from '../assets/Start.png'
                ...
                >
                  ...
                  <div className="flex justify-end items-center gap-3">
                    <div className="cursor-pointer" onClick={() => setShowPicker(!showPicker)}>
                      {showPicker ? (
                        <BsFillEmojiSmileFill className="w-6 h-6 text-[#ffb02e] border-[black]" />
                      ) : (
                    ...
                    <button
                      ...
                      className="bg-[#f8f9fa] border border-none text-[14px] px-3 py-[9px] text-[black] font-bold rounded-[7px] focus:outline-none"
                    >
                      Send
                    </button>
                  </div>
          ...
          <div className={props.className}>
            <div className=''>
              <div className='flex flex-col justify-center items-center gap-y-3'>
                <img className='w-[50%] h-[50%] flex justify-center items-center' alt="User profile" src={start_Chat} />
                <h3 className='text-[#111b21] text-[20px] font-medium tracking-wider'>Welcome<span className='text-[19px] font-bold'> {activeUser.name}</span></h3>
              </div>
            </div>
          </div>
