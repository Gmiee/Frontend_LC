              ...
              <div onClick={() => {
                ...
                <div className='flex items-center gap-x-3 sm:gap-x-1 md:gap-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-[13.6px] sm:text-[13.5px] font-medium text-[#56585c] overflow-hidden truncate w-32'>  {e.latestMessage?.message.length > 30
                ...
                <div className='flex flex-col items-end gap-y-[8px]'>
                  <p className='text-[12.4px] sm:text-[12px] font-normal text-[#b0b2b3] tracking-wide'>
                    {new Date(e.updatedAt).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}
                  </p>
                </div>
